...
\begin{document}
    ...
    \title{Klasifikasi Instrumen Melodis pada Korean Ballad Instrumental dengan CNN dan Spectrogram}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Melodic Instrument Classification on Korean Ballad Instrumentals Using Convolutional Neural Networks and Spectrograms}
