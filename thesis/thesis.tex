...
\begin{document}
    ...
    \title{Analisis Perbandingan Performa Arsitektur PANNs Dengan Pendekatan Input Berbasis \textit{Raw Waveform}, \textit{Log-mel Spectrogram}, dan \textit{Hybrid} untuk Klasifikasi Suara Bahaya}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Analisis Perbandingan Performa Arsitektur PANNs Dengan Pendekatan Input Berbasis \textit{Raw Waveform}, \textit{Log-mel Spectrogram}, dan \textit{Hybrid} untuk Klasifikasi Suara Bahaya}
