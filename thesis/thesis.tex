...
\begin{document}
    ...
    \title{Analisis Performa Arsitektur PANN\lowercase{s} Dengan Pendekatan Input Berbasis \textit{Raw Waveform}, \textit{Log-mel Spectrogram}, dan \textit{Hybrid} untuk Klasifikasi Suara Kedaruratan Perkotaan}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Performance Analysis of PANN\lowercase{s} Architecture using Raw Waveform, Log-mel Spectrogram, and Hybrid Inputs for Urban Emergency Sound Classification}
