...
\begin{enumerate}
    ...
    Proses \textit{down-mixing} ini dilakukan dengan mengambil nilai rata-rata amplitudo dari saluran kiri dan kanan pada setiap titik sampel waktu. \par
    
    Secara matematis, proses ini direpresentasikan sebagai berikut:
