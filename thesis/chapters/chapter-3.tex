...
\begin{enumerate}
    ...
    Serangkaian proses dilakukan untuk mengubah data mentah menjadi format yang siap latih, meliputi penanganan struktur \textit{fold}, seleksi kelas, dan penyesuaian format audio, serta penerapan augmentasi temporal untuk menstandarisasi durasi input.
