...
\begin{enumerate}
    ...
    Performa model hasil \textit{Fine-tuning} dievaluasi menggunakan metrik \textit{F1-Score}, \textit{Loss} dan \textit{Confusion Matrix}, serta analisis efisiensi waktu komputasi yang juga menjadi tolak ukur efektivitas model.
