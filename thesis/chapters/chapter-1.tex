...
\begin{enumerate}[noitemsep]
  ...
  \item Representasi input manakah yang menghasilkan model paling optimal berdasarkan metrik \textit{F1-Score}, nilai \textit{Loss}, dan analisis \textit{Confusion Matrix} untuk meminimalisir kesalahan deteksi pada sistem keselamatan penyandang tunarungu?
\end{enumerate}
...
\begin{enumerate}[noitemsep]
  ...
  \item Mengevaluasi pendekatan representasi input yang menghasilkan model paling optimal berdasarkan metrik \textit{F1-Score}, nilai \textit{Loss}, dan analisis \textit{Confusion Matrix} untuk meminimalisir kesalahan deteksi pada sistem keselamatan penyandang tunarungu.
\end{enumerate}
